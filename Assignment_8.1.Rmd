...
# 2. Create a new data frame iris1 that contfains only the species virginica and versicolor with sepal lengths longer than 6 cm and sepal widths longer than 2.5 cm. How many observations and variables are in the data set?
...
#I know the graph isn't correct, but when I try to knit I am given an error saying "y" is needed for geom_bar(). I left it blank for it to knit, but I originally copied it from your notes as geom_bar(position="dodge", stat="identity")
...
p<- ggplot(data=dryadData, 
  ...
  geom_bar() + #color is outline of the bars // position organizes the ways the bars are shown (dodge is right next to each other) // stat further organizes the bar (identity makes them individual bars)
